        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBudgetedExpenses = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BudgetedExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BudgetedExpenses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BudgetedExpenses_ExpenseCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetedExpenses_CategoryId",
                table: "BudgetedExpenses",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetedExpenses_UserId",
                table: "BudgetedExpenses",
                column: "UserId");
